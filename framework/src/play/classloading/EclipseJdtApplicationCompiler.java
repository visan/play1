 ...
 */
public class EclipseJdtApplicationCompiler implements ApplicationCompiler {
...
//    ApplicationClasses applicationClasses;
     ...
     * @param compilerWorkspace
     */
    public EclipseJdtApplicationCompiler(CompilerWorkspace compilerWorkspace) {
    ...
    final class CompilationUnit implements ICompilationUnit {
        ...
        public char[] getContents() {
            return compilerWorkspace.getJavaSource(clazzName).toCharArray();
        }
...
//                    ApplicationClass applicationClass = applicationClasses.getApplicationClass(name);
                    ...
                    if (compilerWorkspace.containsApplicationClass(name)) {

                        if (compilerWorkspace.getJavaByteCode(name) != null) {
                            ClassFileReader classFileReader = new ClassFileReader(compilerWorkspace.getJavaByteCode(name), fileName, true);
                            return new NameEnvironmentAnswer(classFileReader, null);
                        }
                        // Cascade compilation
        ...
        ICompilerRequestor compilerRequestor = new ICompilerRequestor() {
            ...
            public void acceptResult(CompilationResult result) {
                ...
                for (int i = 0; i < clazzFiles.length; i++) {
                  ...
                  compilerWorkspace.setCompiledBytes(clazzName.toString(),clazzFile.getBytes());
                }
            }
        };
